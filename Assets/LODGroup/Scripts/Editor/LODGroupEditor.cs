...
namespace Chess.LODGroupIJob
{
    ...
    public class LODGroupEditor : LODEditorWindow
    {
        ...
        void RefreshAndStreaming()
        {
            ...
            m_LODGroup.exportStreamDir = EditorGUILayout.ObjectField("流式路径:", m_LODGroup.exportStreamDir, typeof(Object), false);
        }
        ...
        void LODDataOp()
        {
            ...
            if (renderers.Count > 0)
            {
                ...
                {
                    var obj = EditorGUILayout.ObjectField(renderer, typeof(GameObject), true, GUILayout.Width(150));
                    if (obj == null)
                    {
