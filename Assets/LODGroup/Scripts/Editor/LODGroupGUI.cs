...
namespace ClientCore.LODGroupIJob.Editor
{
    public static class LODGroupGUI
    {
        ...
        public class GUIStyles
        {
            ...
            public readonly GUIContent m_ExportStreamModeLabel = EditorGUIUtility.TrTextContent("Export Mode", "Select export stream mode, None is not stream mode, Renderers will export all renderers, GameObjects will export all game object nodes.");
            public readonly GUIContent m_ExportStreamDirLabel = EditorGUIUtility.TrTextContent("Export Folder", "Export the object prefabs to the special folder. Use the available asset folder for runtime.");
            public readonly GUIContent m_OneKeyStreamLabel = EditorGUIUtility.TrTextContent("一键流式加载", "Export all the children objects to the special folder, will load the asset on the runtime.");
            public readonly GUIContent m_OneKeyBackNormalLabel = EditorGUIUtility.TrTextContent("一键回退流式", "Back to the normal way to switch the children's renderer.");
            public readonly GUIContent m_StreamingLoadPriorityLabel = EditorGUIUtility.TrTextContent("Priority:", "Streaming load priority for current lod level.");
            public readonly GUIContent m_StreamingObjectPreviewLabel = EditorGUIUtility.TrTextContent("Preview:", "Streaming object preview in editor mode.");
            public readonly GUIContent m_StreamingObjectLabel = EditorGUIUtility.TrTextContent("Streaming Object:", "Streaming object drag from existing folder.");
